...
sg = sendgrid.SendGridAPIClient(api_key='SG.dfdfdfdfadsfeefrewqewq.KyAYHdsfdsfdsfldsfdsfdsfdsfdsfdsfdsfiqi0') 

conn = ibm_db.connect("DATABASE=bluedb; HOSTNAME=55444447-92433466-4331-af32442343d3-888b05e723423434c0.bs2io90l08kq234234234b1od8lcg.databases.appdomain.cloud; PORT=31000; SECURITY=SSL; SSLServerCertificate=DigiCertGlobalRootCA.crt; UID=kjdghsf50005; PWD=khesseerersb",'','')
...
def register():
  ...
  if request.method == 'POST':
    ...
    if account:
      ...
      content = Content("text/plain", "Your registration is confirmed. Thank you. SharingJoy")
